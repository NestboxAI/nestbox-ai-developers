...
This page describes all commands available in the <SiteName /> CLI for managing compute instances. Compute instances are required to host and run agents. You can create, list, and remove them, as well as select the compute image and configuration used.
